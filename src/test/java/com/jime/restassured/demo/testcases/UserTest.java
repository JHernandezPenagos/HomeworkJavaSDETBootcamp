...
import com.jime.restassured.demo.model.user.UsersModel;
...
public class UserTest extends BaseTest{
    ...
    void verifyAllUsersAreRetrieved(){
        /*setEndPoint("users/");
        actualModel = getInstance(UsersModel.class);
        actualModel.as(UsersModel.class).getData().size().forEach(System.out::println;)
        System.out.println(actualModel.as(UserModel));*/
        setEndPoint("users/");
        actualModel = getInstance(UsersModel.class);
        actualModel.as(UsersModel.class).getData().forEach(System.out::println);
